...
# CUDA debugging and memory management environment variables
export CUDA_LAUNCH_BLOCKING=1
export TORCH_USE_CUDA_DSA=1
# Note: PYTORCH_CUDA_ALLOC_CONF with expandable_segments is incompatible with vLLM
# Let vLLM manage its own memory pool
...
exp_name='Qwen3-MoE-8k-deepscaler-grpo-router-kl-loss-B200'
