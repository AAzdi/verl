...
export WANDB_API_KEY=26df763b1f0d6055d79a05ac0edefc74defbc81c
...
project_name='MoE-TTS-Moonlight'
exp_name='moonlight-MoE-8k-deepscaler-grpo-router-kl-loss-mi300'
...
# Paths
MODEL_PATH=/mnt/msranlp/xun/reasoning/MoE-TTS/cpkts/moonshotai/Moonlight-16B-A3B
DIST_CKPT_PATH=/mnt/msranlp/xun/reasoning/MoE-TTS/cpkts/moonshotai/Moonlight-16B-A3B-mcore
DEFAULT_LOCAL_DIR=/mnt/dizhang/reasoning/MoE-TTS/kimi_training_results/deepscaler/moonlight-MoE/${exp_name}
